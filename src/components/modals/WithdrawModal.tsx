...
export default function WithdrawModal({
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    onConfirm({
      ...
      obs,
      checkProntos: allChecked,
      location,
      photos,
      customChecklistData: checks,
    });
    setDriver('');
    setKm('');
    setFuel('Reserva');
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t('modalWithdraw', currentLang)}>
      <form onSubmit={handleSubmit}>
        ...
        <div style={styles.formGroup}>
          <label htmlFor="wd-f1" style={styles.label}>
        ...
        <div style={styles.formGroup}>
          <label htmlFor="wd-f2" style={styles.label}>
            {t('lblKm', currentLang)}
          </label>
          <input
            id="wd-f2"
        ...
        <div style={styles.formGroup}>
          <label htmlFor="wd-f3" style={styles.label}>
        ...
        <div style={styles.formGroup} role="group" aria-labelledby="wd-checklist-title">
          <span id="wd-checklist-title" style={styles.label}>
            Checklist de Saída
          </span>
        ...
        <div style={styles.formGroup}>
          <label htmlFor="wd-f5" style={styles.label}>
