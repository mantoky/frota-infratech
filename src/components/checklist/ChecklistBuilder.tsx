    ...
    >
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: '1px solid var(--border)',
                background: field.active ? 'rgba(46,204,113,0.15)' : 'var(--bg-main)',
                cursor: 'pointer',
              }}
            >
      ...
      {isAdmin && (
        <>
          ...
          >
            <input
              placeholder="Novo campo do checklist"
              value={newLabel}
            ...
            <select
              value={newCategory}
              onChange={(e) => setNewCategory(e.target.value as ChecklistField['category'])}
              style={{
                padding: 10,
                borderRadius: 8,
                border: '1px solid var(--border)',
          ...
          <button
            type="button"
            onClick={() => onSaveFields(localFields)}
            style={{
              padding: '10px 16px',
              borderRadius: 8,
              border: 'none',
